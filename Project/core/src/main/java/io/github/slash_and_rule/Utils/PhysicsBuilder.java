...
public class PhysicsBuilder {
    ...
    public Fixture addFixture(Body body, Shape shape, float density, float friction, float restitution, short category,
            short mask) {
        Fixture fixture = body.createFixture(makeFixtureDef(shape, density, friction, restitution, category, mask));
    ...
    public Fixture addFixture(Body body, Shape shape, float density, float restitution, short category, short mask) {
        return addFixture(body, shape, density, 0f, restitution, category, mask);
    }

    public Fixture addFixture(Body body, Shape shape, float density, short category, short mask) {
        return addFixture(body, shape, density, 0f, 0f, category, mask);
    }

    public Fixture addFixture(Body body, Shape shape, short category, short mask) {
        return addFixture(body, shape, 0f, 0f, 0f, category, mask);
    }
